package com.infractions.aggregates;
...
public class VehicleRegistrationCenterAggregate {
    ...
    @CommandHandler
    public void handle(UpdateVehicleOwnerCommand command) throws Exception {
        log.info("UpdateVehicleOwnerCommand received");
        if(this.ownerNationalIdCard.equals(command.getPayload().getOwnerNationalIdCard()))
            throw new Exception("This Owner is already affected to this vehicle");
